...
def main():
    ...
    for feat_dir, weight in feat_dir_dict.items():
        ...
        # with open('/home/data1/changhao/iBioHash/Codes/pytorch-image-models-main/lrd_save/dis.pkl','rb') as f1:
        #         dis = pickle.load(f1)
        with open('/home/data1/changhao/iBioHash/Codes/pytorch-image-models-main/lrd_save/sorted_index.pkl','rb') as f2:
                sorted_index = pickle.load(f2)
        sorted_index = torch.tensor(sorted_index)
        ...
        if mode_split == 'method1':  # 分组后，组内top必须严格相同
            ...
            #         skip_i.extend([i, int(top4_index[1]), int(top4_index[2]), int(top4_index[3])])  # 包含则之后跳过处琄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            ...
            for i in range(len(sorted_index)):
                ...
                if top3_index.equal(temp1_index) and top3_index.equal(temp2_index):
                    skip_i.extend([i, int(top3_index[1]), int(top3_index[2])])  # 包含则之后跳过处琄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            ...
            for i in range(len(sorted_index)):
                ...
                if top2_index.equal(temp1_index):
                    skip_i.extend([i, int(top2_index[1])])  # 包含则之后跳过处琄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
                    group_2.append([i, int(top2_index[1])])
            # print(group_3) # 有近300组，900个query, 6000个gallery
            # print(group_2)  # 有近1837组，3674个query＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�777736740个gallery
            # 可解冄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77774574个query，剩佄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77775426个各戄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77771组，只能使用剩余的1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�777747260个gallery，明显不够�ￄ1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            # 扢�以需要放宽条件，改为＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77775丄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77771组，只要互相之间朄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77774个相同即可；4个一组，只要互相朄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77773个相同即可；3个一组，只要互相朄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77772个相同即可；2个一组，彼此互为top1
        elif mode_split == 'method2':
            # 放宽条件，不必完全相同，可有1个不各1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            skip_i = []
            group_select = []
            for topk_select in range(5, 2, -1):
                ...
                for i in range(len(sorted_index)):
                    ...
                    if cnt >= topk_select - 1:  # 满足互相至少包含topk-1个相同的query
                        # 排除两组之间有重复元素的情况
                        flag_re = False  # 重复标志佄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
                        ...
                        if flag_re:
                            print("re condition")
                            continue  # 跳过该query，继续寻扄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            ...
            # 5:929组，4645个query，需18580个gallery＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            # 4＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777193组，772个query，需3860个gallery＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            # 3＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777413组，1239个query，需8260个gallery＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            # 2＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777203组，406个query，需4060个gallery＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
            # 1＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�77772938组，2938个query，需58760个gallery＄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777 共需93520个gallery，有1w的缺口，但大致ok
        ...
        #     # for topk_select in range(100, 5, -1):   # 仄1�71ￄ1�771ￄ1�71ￄ1�77710个一组开始寻找，找组内的公共子集＄1�71ￄ1�771ￄ1�71ￄ1�777
        #     while topk_select > 1:
        ...
        #             public_subset = []
        #             for el in elements: 
        #                 if elements[el] >= topk_select - margin: # 如topk_select=10，若某个query出现8次，则认为属于公共子雄1�71ￄ1�771ￄ1�71ￄ1�777
        #                     public_subset.append(el)
                    
        #             if len(public_subset) < topk_select - margin: # 如topk_select=10，若公共子集长度小于8，则认为质量不太髄1�71ￄ1�771ￄ1�71ￄ1�777
        #                 continue
        ...
        #         topk_select -= margin
            ...
            skip_i = []
            group_select = [[] for i in range(150)]
            # 寻找公共子集
            ...
            for i in range(len(sorted_index)):
                ...
                topk_index = sorted_index[i][:100]
                
                temp_index = []
                for top_i in range(len(topk_index) - 1):
                    temp_index.append(sorted_index[topk_index[top_i + 1]][:100].sort().values)
                temp_index.append(topk_index.sort().values)
                ...
                while topk_select >= 30:
                    group_flag = False
                    
                    margin1 = hyp_dict[topk_select // 10][0]
                    margin2 = hyp_dict[topk_select // 10][1]
                    ...
                    #         q_temp = int(q_temp)
                    #         elements[q_temp] = elements.get(q_temp, 0) + 1
                    for ti in range(topk_select):
                        for idx, q_temp in enumerate(temp_index[ti]):
                            if idx >= topk_select:
                                break
                            q_temp = int(q_temp)
                            elements[q_temp] = elements.get(q_temp, 0) + 1
                    ...
                    # public_subset_pre = public_subset
                    public_subset = []
                    for el in elements: 
                        if elements[el] >= margin1: # 如topk_select=10，若某个query出现8次，则认为属于公共子雄1�71ￄ1�771ￄ1�71ￄ1�777
                            public_subset.append(el)
                    
                    if len(public_subset) < margin2: # 如topk_select=10，若公共子集长度小于8，则认为质量不太髄1�71ￄ1�771ￄ1�71ￄ1�777
                        topk_select -= 1
                        continue
                    else:
                        group_flag = True
                ...
                new_group_select =[]
                for groups in group_select:
                    if len(groups):
                        new_group_select.append(groups)

                group_select = [[] for i in range(150)]
                
                
                imagenet_root = '/home/data1/changhao/iBioHash/Datasets/metaformer_merge_data_hyp1'
                src_root = '/home/data1/changhao/iBioHash/Datasets'
                
                for groups in new_group_select:
                    for group in groups:
                        cnt_dict[len(group)] = cnt_dict.get(len(group), 0) + 1
                        dist_path = os.path.join(imagenet_root, str(class_cnt))
                        class_cnt += 1
                        os.makedirs(dist_path, exist_ok=True)
                        for img_idx in group:
                            image_name = total_names[img_idx]
                            gallery_path = os.path.join(src_root, 'iBioHash_Gallery/Gallery', image_name + '.jpg')
                            query_path = os.path.join(src_root, 'iBioHash_Query/Query', image_name)

                            src_path = query_path if os.path.exists(query_path) else gallery_path
                            shutil.copy(src_path, dist_path)
            
            for i, cnt in cnt_dict.items():
                if cnt == 0:
                    continue
                print('长度为{}的组: {}'.format(i, cnt))
            # for idx, t in enumerate(group_select):
            #     if idx < 20 or not len(t):
            #         continue
            #     print('长度为{}的组: {}'.format(idx, len(t)))
            ...
            #     print("{}: {}组1�7, {}个query".format(i, len(group_select[i]), i * len(group_select[i])))
            # print("1: 1组1�7, {}个query".format(10000 - stat_q_num))
            
            # 先不处理1组，先交丢�牄1�71ￄ1�771ￄ1�71ￄ1�777
            # group_select.pop(0)
            # group_select.pop(0)
        ...
        # for group_idx in range(9): # topk 5-2, # 调换分配顺序，先分配10组，朢�后分酄1�71ￄ1�771ￄ1�71ￄ1�7772组1�71ￄ1�771ￄ1�71ￄ1�777
        ...
        #         # 思路有问预1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
        #         # 逐top分配gallery
        ...
        #         #         #     current_gallery_point[q_index_i] += 1  # query对应gallery的指钄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777 + 1
        ...
        #         # 方法丢�＄1�71ￄ1�771ￄ1�71ￄ1�777 取一组内不重复的朢�相似的gallery；方法二：取出现次数朢�多的gallery
        #         # 方法丢�
        ...
        #                 while cur_g_index in used_gallery_index:  # gallery已分配过，从总的里面眄1�71ￄ1�771ￄ1�71ￄ1�777
        ...
        #     for group_topk_select_i in range(len(group_select)): # 先从2组开始，丢�直遍历到10组1�71ￄ1�771ￄ1�71ￄ1�777
        ...
        #                 max_i = sim_i
        #                 max_j = sim_j
        #     # 如果max_sim>=交集数量阈�ￄ1�71ￄ1�771ￄ1�71ￄ1�777, 记录要加入的组1�71ￄ1�771ￄ1�71ￄ1�777
        #     if max_sim >= sim_cnt_thr:
        #         re_assign_single_q[i] = (max_i, max_j)
        
        # print('单个query在交集数量阈倄1�71ￄ1�771ￄ1�71ￄ1�777={}下，成功合并的数釄1�71ￄ1�771ￄ1�71ￄ1�777={}'.format(sim_cnt_thr, len(re_assign_single_q)))
        # # 将单个query合并刄1�71ￄ1�771ￄ1�71ￄ1�7772及以上组 
        ...
        # # 05/06 ------------- 弢�始处琄1�71ￄ1�771ￄ1�71ￄ1�7771组1�71ￄ1�771ￄ1�71ￄ1�777 ---------------
        # # 将单个的query分配组1�71ￄ1�771ￄ1�71ￄ1�777 已分好的组1�71ￄ1�771ￄ1�71ￄ1�777


        # # 分配单个的query, 应当成一个大组1�71ￄ1�771ￄ1�71ￄ1�777
        # group_single_select = []
        # for i in range(10000):
        #     if i in skip_i:
        #         continue
        ...
        #             #     break 
        #             if current_gallery_point[q_index_i] >= 270: # 1000个类别中，起码跨越了3个类, 再往外找应该也是错的亄1�71ￄ1�771ￄ1�71ￄ1�7771ￄ1�71ￄ1�771ￄ1�71ￄ1�7777
