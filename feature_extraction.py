...
parser.add_argument('--data-dir', metavar='DIR',default='/home/data1/changhao/iBioHash',
...
# -------------------
parser.add_argument('--gallery_split', metavar='NAME', default='Gallery/Gallery',
                    help='dataset split (default: validation)')
parser.add_argument('--query_split', metavar='NAME', default='Query/Query',
                    help='dataset split (default: validation)')
...
def main():
    ...
    if len(model_cfgs):
        ...
        if args.retry:
            ...
            similarity_index = similarity_tensor.topk(k=50, dim=1)[1]  # indices
